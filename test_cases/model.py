...
def train_model(features_path, model_path):
    ...
    X_train = vectorizer.fit_transform(training_data['features'])  # No need for .tolist() here
...
def evaluate_model(features_path, model_path):
    ...
    X_val = vectorizer.transform(validation_data['features'])  # No need for .tolist() here
